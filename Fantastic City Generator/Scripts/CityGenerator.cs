            ...
            while (t < 10)
            {
                ...
                if (distancia < _distCenter && withDowntownArea)
                {
                    ...
                    do
                    {
                        ...
                        if (_EC[numB] == 0) break;
                        if (lp > 60 && _EC[numB] <= 1) break;
                        if (lp > 100 && _EC[numB] <= 2) break;
                        if (lp > 150 && _EC[numB] <= 3) break;
                ...
                else
                {
                    ...
                    do
                    {
                        ...
                        if (_EB[numB] == 0) break;
                        if (lp > 60 && _EB[numB] <= 1) break;
                        if (lp > 100 && _EB[numB] <= 2) break;
                        if (lp > 150 && _EB[numB] <= 3) break;
                ...
                foreach (Transform bk in bks.transform)
                {
                    ...
                    if (Random.Range(0, 20) > 5)
                    {
                        ...
                        do
                        {
                            ...
                            if (_BK[numB] == 0) break;
                            if (lp > 40 && _BK[numB] <= 1) break;
                            if (lp > 60 && _BK[numB] <= 2) break;
                            if (lp > 120 && _BK[numB] <= 3) break;
            ...
            foreach (GameObject bks in tempArray)
            {
                ...
                foreach (Transform bk in bks.transform)
                {
                    ...
                    do
                    {
                        ...
                        if (_SB[numB] == 0) break;
                        if (lp > 30 && _SB[numB] <= 1) break;
                        if (lp > 60 && _SB[numB] <= 2) break;
                        if (lp > 100 && _SB[numB] <= 3) break;
