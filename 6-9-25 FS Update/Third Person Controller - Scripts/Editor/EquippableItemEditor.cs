...
namespace FS_ThirdPerson
{
    public class EquippableItemEditor : AnimationPreviewHandler
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            equipmentSettings = EditorGUILayout.Foldout(equipmentSettings, "Equipment Configuration", true);
            if (equipmentSettings)
            {
                ...
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
                {
                    ...
                    if (equipFoldout)
                    {
                        ...
                        {
                            EditorGUILayout.Slider(itemEnableTime, 0, 1, new GUIContent("Activation Time"));
                        }
                    ...
                    if (unEquipFoldout)
                    {
                        ...
                        {
                            EditorGUILayout.Slider(itemDisableTime, 0, 1, new GUIContent("Deactivation Time"));
                        }
