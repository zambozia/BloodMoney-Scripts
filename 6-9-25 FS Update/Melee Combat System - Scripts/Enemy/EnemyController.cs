...
namespace FS_CombatSystem
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                if (Fighter.CurrentWeaponData != null && Fighter.CurrentWeaponData.CanBlock && !Fighter.IsBlocking && !Fighter.IsBusy && Fighter.Target != null)
                {
            ...
            Fighter.OnWeaponEquipAction += (WeaponData weaponData) =>
            {
            ...
            //Fighter.OnTakeDamage -= damagable.TakeDamage;
            //Fighter.OnTakeDamage += damagable.TakeDamage;
        }
        ...
        private void Update()
        {
            ...
            if (Fighter.Target?.damagable.CurrentHealth <= 0)
            {
