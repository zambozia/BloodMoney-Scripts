...
namespace AssetLibraryManager
{
    public class PrefabLabels : EditorWindow
    {
        ...
        public static int searchMethod = 1, oldSearchMethod;
        string[] searchMode = { "ANY", "ALL" };


        [MenuItem("Tools/Asset Library Manager/Prefab Labels...", false, 66)]
        ...
        void CreateGUI()
        {
            ...
            LabelsManager.projectLabels = new List<string>(customLabels);        
        }
        ...
        void OnGUI()
        {
            ...
            content.tooltip = "Prefab Viewer";
            content.image = Resources.Load("icons/alm/viewer") as Texture2D;
            ...
            content.tooltip = "Preview window";
            ...
            if (customFold == true)
            {
                ...
                for (int i = 0; i < customLabels.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        GUI.backgroundColor = new Color(0.85f, 1.1f, 1.4f);
            ...
            foreach (var id in SearchLabels.cacheGuids)
            {
                ...
                if (searchMethod == 0)
                {
                    ...
                    for (int i = 0; i < getLabels.Count; i++)
                    {
                        ...
                        if (settings.options.useIgnoreTag == true)
                        {
                            if (getLabels[i] != "Ignore")
                            {
