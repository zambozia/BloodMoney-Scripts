...
namespace FS_CombatSystem
{
    ...
    public class EnemyController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (Animator == null)
            {
                Debug.LogError($"[EnemyController] Animator is missing on {gameObject.name}. This will break movement.");
            ...
            if (Animator.runtimeAnimatorController == null)
            {
                if (fallbackAnimatorController != null)
                {
                    ...
                    Debug.LogWarning($"[EnemyController] Animator controller was missing at runtime. Fallback assigned to {gameObject.name}");
                }
                else
                {
                    Debug.LogError($"[EnemyController] Missing Animator Controller and no fallback assigned! This will break animations on {gameObject.name}");
                }
            }
        ...
        private void OnAnimatorMove()
        {
            if (Animator == null)
            {
                Debug.LogWarning($"[EnemyController] Animator is missing on {gameObject.name}. Skipping OnAnimatorMove.");
                return;
            }
