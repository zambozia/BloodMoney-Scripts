...
namespace AmplifyAnimationPack
{
	public class JumpState : CharacterStateBase
	{
		...
		public override void EnterState()
		{
			...
			charRef.rigid.linearVelocity = Vector3.zero;
		...
		public override void UpdateState()
		{
			...
			if( charRef.rigid.linearVelocity.y < 0 )
			{
				// calculates jumpTime
				...
				charRef.rigid.linearVelocity += ( Vector3.up * Physics.gravity.y + charRef.transf.forward * currentJumpFowardVel * ( charRef.isJumpingForward ? 1f : 0f ) )
					* charRef.jumpFallMultiplier * Time.deltaTime;

				canLand = ( charRef.rigid.linearVelocity.y < -1f );
			}
