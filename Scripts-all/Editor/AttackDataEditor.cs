...
namespace FS_CombatSystem
{
    ...
    public class AttackDataEditor : AnimationPreviewHandler
    {
        ...
        {
            base.OnEnable();
            animationClip = serializedObject.FindProperty("clip");
            ...
            reactionClip = reaction.FindPropertyRelative("animationClip");
            ...
            blockedReactionClip = serializedObject.FindProperty("blockedReaction").FindPropertyRelative("animationClip");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(animationClip, new GUIContent("Attack Clip"));
            ...
            {
                EditorGUI.BeginChangeCheck();
                EditorGUILayout.PropertyField(blockedReactionClip, new GUIContent("Clip"));
